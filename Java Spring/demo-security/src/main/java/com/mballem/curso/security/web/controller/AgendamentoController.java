...
public class AgendamentoController {
	...
	public ResponseEntity<?> getHorariosNaoAgendadosPorMedicoEData(@PathVariable("id") Long id,
	...
	public String salvar(Agendamento agendamento, RedirectAttributes attr, @AuthenticationPrincipal User user){
		Paciente paciente = pacienteService.buscarPorPacienteEmail(user.getUsername());
		String titulo = agendamento.getEspecialidade().getTitulo();
		Especialidade especialidade = especialidadeService
				.buscarEspecialidadesPorTitulos(new String[] {titulo})
